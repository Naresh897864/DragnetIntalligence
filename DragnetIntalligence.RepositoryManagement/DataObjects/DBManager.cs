...
namespace Dragnet.DataObjects
{
    public class DBManager : IDBManager, IDisposable
    {
        ...
        public DBManager()//default connection
        {
            ...
            _connectionString = root.GetSection("Tec").GetSection("ConnectionStringTec").Value;
            this.ConnectionString = root.GetSection("Tec").GetSection("ConnectionStringTec").Value;

            //_connectionString = "server=10.10.11.95;database=aplrchi10;user id=aplrchiapp;password=TYL8G@NyLB";
            //this.ConnectionString = "server=10.10.11.95;database=aplrchi10;user id=aplrchiapp;password=TYL8G@NyLB"; 
            //this.ConnectionString = "server=10.160.19.137;database=Webland;user id=sa;password=3908#aGpr";
            //this.ConnectionString = "server=LAPTOP-47KSN49N;database=Webland;user id=sa;password=123";
        }
        ...
        //    var root = configurationBuilder.Build();
        //    _connectionString = root.GetSection(connectionname).GetSection("ConnectionStringTec").Value;
        //    this.ConnectionString = root.GetSection(connectionname).GetSection("ConnectionStringTec").Value;
        //}


        /* public DBManager(string DistrictId)//connection with name
         {
             //get the provicer type from the web.config file
             string typeOfProvider = "SqlServer";
             //  get the provider type passed from the sql server
             ...
             var root = configurationBuilder.Build();
             //_connectionString = root.GetSection(DistrictId.ToString()).GetSection("ConnectionString").Value;
             //this.ConnectionString = root.GetSection(DistrictId.ToString()).GetSection("ConnectionString").Value;
             _connectionString = root.GetSection(DistrictId).GetSection("ConnectionString").Value;
             this.ConnectionString = root.GetSection(DistrictId).GetSection("ConnectionString").Value;
         }*/
